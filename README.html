 NAO Library Assistant - Relazione Tecnica @page { size: A4; margin: 1.5cm; } body { font-family: 'Times New Roman', serif; font-size: 12pt; line-height: 1.6; color: #000; background: white; max-width: 21cm; margin: 0 auto; padding: 1.5cm; } .cover-page { text-align: center; padding-top: 4cm; page-break-after: always; position: relative; min-height: 25cm; } .university-logo { font-size: 24pt; font-weight: bold; color: #003366; margin-bottom: 1cm; } .main-title { font-size: 20pt; font-weight: bold; color: #1a1a1a; margin: 1cm 0; line-height: 1.4; } .subtitle { font-size: 16pt; color: #555; margin: 1.5cm 0; } .course-info { font-size: 14pt; margin: 2cm 0; line-height: 2; } .author-info { font-size: 14pt; margin: 2cm 0; line-height: 1.8; background: #f8f9fa; padding: 20px; border-radius: 8px; border: 2px solid #dee2e6; } h1 { font-size: 18pt; font-weight: bold; color: #1a1a1a; margin-top: 30px; margin-bottom: 15px; border-bottom: 2px solid #333; padding-bottom: 5px; } h2 { font-size: 14pt; font-weight: bold; color: #333; margin-top: 25px; margin-bottom: 12px; border-bottom: 1px solid #ccc; padding-bottom: 3px; } h3 { font-size: 13pt; font-weight: bold; color: #555; margin-top: 20px; margin-bottom: 10px; } h4 { font-size: 12pt; font-weight: bold; color: #666; margin-top: 15px; margin-bottom: 8px; } .toc { page-break-after: always; margin-top: 2cm; } .toc-title { font-size: 18pt; font-weight: bold; text-align: center; margin-bottom: 2cm; border-bottom: 2px solid #333; padding-bottom: 10px; } .toc-item { display: flex; justify-content: space-between; margin: 8px 0; border-bottom: 1px dotted #ccc; padding-bottom: 2px; } .info-box { background: #f8f9fa; border: 2px solid #007bff; padding: 20px; margin: 20px 0; border-radius: 8px; } .warning-box { background: #fff3cd; border: 2px solid #856404; padding: 15px; margin: 15px 0; border-radius: 5px; border-left: 5px solid #856404; } .success-box { background: #d4edda; border: 2px solid #155724; padding: 15px; margin: 15px 0; border-radius: 5px; border-left: 5px solid #155724; } .code-block { background: #f1f3f4; border-left: 4px solid #4285f4; padding: 15px; margin: 20px 0; font-family: 'Courier New', monospace; font-size: 10pt; white-space: pre-wrap; overflow-x: auto; border-radius: 4px; } .architecture-diagram { border: 2px solid #333; padding: 25px; margin: 25px 0; text-align: center; background: #fafafa; font-family: 'Courier New', monospace; font-size: 9pt; white-space: pre; border-radius: 5px; } .directory-tree { font-family: 'Courier New', monospace; font-size: 10pt; background: #f8f9fa; border: 2px solid #dee2e6; padding: 20px; margin: 20px 0; white-space: pre; border-radius: 5px; } table { width: 100%; border-collapse: collapse; margin: 20px 0; font-size: 11pt; } th, td { border: 1px solid #333; padding: 10px; text-align: left; } th { background-color: #e9ecef; font-weight: bold; } tr:nth-child(even) { background-color: #f8f9fa; } ul, ol { margin-left: 25px; margin-bottom: 15px; } li { margin-bottom: 5px; } .page-break { page-break-before: always; } .figure-caption { text-align: center; font-style: italic; margin-top: 10px; color: #666; } .emphasis { background-color: #fff3cd; padding: 2px 4px; border-radius: 3px; } @media print { body { margin: 0; padding: 1cm; font-size: 11pt; } .no-print { display: none; } .cover-page { padding-top: 2cm; } }
